...
let ACCOUNT0 = {
  ...
  safeAddress: null // resolved dynamically in beforeAll
}
...
describe('@wdk/wallet-evm-erc-4337', () => {
  ...
  beforeAll(async () => {
    ...
    // Derive accounts to get actual Safe addresses (predicted via Safe4337Pack)
    ...
    // Update expected addresses to match Safe4337Pack predictions
    ACCOUNT0.safeAddress = safeAddress0
    ACCOUNT1.safeAddress = safeAddress1
    ...
    await mintMockTokens(safeAddress0, ethers.parseEther('10000'), fundedWallet, nonce++)
    await mintMockTokens(safeAddress1, ethers.parseEther('10000'), fundedWallet, nonce++)
  }, TIMEOUT)
