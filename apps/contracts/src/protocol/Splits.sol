...
abstract contract Splits {
    ...
    bytes32 private immutable _SPLITS_STORAGE_SLOT;
    ...
    constructor(bytes32 splitsStorageSlot) {
        _SPLITS_STORAGE_SLOT = splitsStorageSlot;
    }
        ...
        returns (uint128 collectableAmt, uint128 splitAmt)
    {
        ...
        unchecked {
            ...
            // result bounded by _TOTAL_SPLITS_WEIGHT
        ...
        returns (uint128 collectableAmt, uint128 splitAmt)
    {
        ...
        unchecked {
            ...
            for (uint256 i = 0; i < currReceivers.length; i++) {
                ...
                // result bounded by _TOTAL_SPLITS_WEIGHT
                // forge-lint: disable-next-line(unsafe-typecast)
                uint128 currSplitAmt = uint128(collectableAmt * splitsWeight / _TOTAL_SPLITS_WEIGHT) - splitAmt;
    ...
    function _splitsStorage() private view returns (SplitsStorage storage splitsStorage) {
        bytes32 slot = _SPLITS_STORAGE_SLOT;
